"""Independent rigid reference with a scaled trace-gas element balance.

Uses simultaneous gas, pressure, volume and phase-fraction equations.
The candidate direct coexistence partial-pressure formulas are not used.
"""
