"""Static research prototype for C>0, O>Ca and positive nitrogen inventory.

This does not change the qualified restricted-domain production decoder.
Gas partial pressures at calcium coexistence are solved directly so that
trace gas is not recovered by subtracting nearly equal carbon inventories.
"""
import math
...
def at_temperature_pressure(model, temperature, pressure, inventory):
