"""Plot recorded coupled solid/gas equilibrium and its calorimetric ledgers."""
import argparse
import json
...
def main():
    ...
    ax.set(ylabel='Equilibrium Cp (J/K)',xlabel='Temperature (K)',title='Reaction contribution and phase-boundary jumps')
    ax=axes[2,0];ax.plot(t,[r['values'][1] for r in data],color=p['energy_color']);ax.set(ylabel='Net heat into mixture (J)',xlabel='Time (min)',title='Total source enthalpy carries chemical energy')
