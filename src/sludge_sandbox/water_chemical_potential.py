...
class WaterChemicalPotential:
    ...
    def __init__(self,source_directory):
        object.__setattr__(self,'water',load_water_properties(source_directory))
        object.__setattr__(self,'vapor',IdealWaterVapor(source_directory))
    ...
    def _check_identity(self):
        if (type(self.water) is not WaterProperties or type(self.vapor) is not IdealWaterVapor
