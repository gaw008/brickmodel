"""Caloric inventory derivatives for positive-inventory trace coexistence.
...
def caloric_inventory_tangent(model,state,volume_m3,calcium_atoms_mol,carbon_atoms_mol,oxygen_atoms_mol):
