...
范围：完整保留 `docs/GOAL_BRICK_PHYSICS_SANDBOX.md` 的 G0–G5 和第 11 节条件，包括原污泥、湿坯到冷却的厚度一维耦合、三个机制组的公开实验对照、真实多代搜索、CLI/Python/本地中文界面。制造解和探索情景只能帮助开发，不能替代来源完整的原污泥全周期案例。
