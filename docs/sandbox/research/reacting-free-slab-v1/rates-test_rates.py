...
from sludge_sandbox.free_slab_rates import solve_free_slab_rates as original
from sludge_sandbox.reacting_skeleton_energy import ManufacturedReactingSkeletonEnergy as Reacting
spec=importlib.util.spec_from_file_location('sludge_sandbox._reacting_rates',Path(__file__).with_name('free_slab_rates.py'))
...
def test_q_one_and_fixed_identity_parity():
    ...
    old=original(base,**kw);fixed=m.solve_free_slab_rates(base,**kw)
