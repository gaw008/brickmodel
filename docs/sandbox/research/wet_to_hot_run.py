...
from test_wet_to_hot_host import run_wet_to_hot,audit_wet_to_hot
from test_joined_water_host import joined
...
if __name__=='__main__':
    ...
    op,result=run_wet_to_hot(ingredients.__wrapped__(),joined.__wrapped__())
    ...
    try:
        data['audit']=audit_wet_to_hot(op,result)
