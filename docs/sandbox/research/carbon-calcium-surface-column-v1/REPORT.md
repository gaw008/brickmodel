...
32格精细轨迹现已结束，41391步、9043.27s。原记录80个分片、1475111913压缩字节，逐字节回读一致。基础档完整审查的2阶收支通过，4阶仍在执行；精细档独立完整审查已启动。未做32格时间和16→32空间最终资格判断。


## 三十二格完整资格与16→32比较

两档完整来源、表面闭合、逐格和外界收支、能量分账、熵及2/4阶求积核查现已全部通过。6000个共同时间观测的最大T差5.310924e−7 K、P差2.616245e−4 Pa、相量差9.036634e−14 mol，时间预算通过。

16→32的6001个共同空间观测仍未通过四项预算：均温0.707474 K、父格温度2.172611 K、均压1302.702473 Pa、总相量1.208566e−5 mol。父格压力22001.275239 Pa仅为诊断。保留原预算与失败结论；32格不能获得空间收敛资格，更不能据此声称实际砖烧制已验证。下一64格仍须单独完整核查及32→64空间比较。

## 2026-09-26 11:47 UTC：既有计算完成记录

64格基础档已正常完成30000s积分，共54266接受步，记录积分耗时32506.55625420902s。终态汇总保存在sixty-four-base-completion.json，SciPy差分警告原样保留。积分完成不等于完整来源/收支审计或时间/空间收敛通过；这些本档审查尚未执行。按用户新全流程合同不追加旧路线的精细档或更大网格，保留已有轨迹及未完成项，材料适用性和现实对照待实测。
