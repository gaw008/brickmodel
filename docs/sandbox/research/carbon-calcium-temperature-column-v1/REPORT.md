...
这是显式重新初始化BDF历史的续算；完整轨迹物理审计、时间配对及空间资格未执行，不能以积分成功授予资格。refined仍在运行。按新全流程工程合同，不追加此旧路线的审计或网格扫描；后续只保存其自然结束的证据并完成目录与存储收尾。

## 2026-09-26 02:40 UTC：128 格完整及时间资格通过，空间相量仍失败

128 格基础和精细两档均通过全部来源、局部/整体元素与内能、熵、两阶/四阶积分要求。精细轨迹核对2680576个保存格状态及15314688个稠密格状态；最大整体能量差1.7686034e−8J，熵账差1.6586087e−11J/K。1000个共同观测的两档最大格温差3.819514e−8K、压差.000151049Pa、物种量差1.891530e−14mol，全部时间要求通过。

64→128 格的1001个共同观测中，平均温差.01471757K、父格温差.09465627K、平均压差2.213045Pa均通过原预算。但总物种差2.10029435e−7mol（CO₂）仍超过1e−8mol；方解石/石灰各约1.45318538e−7mol、CO约1.29421795e−7mol。父格压差548.479Pa是另行记录、没有预算的量，未称通过。空间资格仍未获得，原所有较粗网格失败保留。

更大网格需要继续控制空间误差；先处理轨迹保存的磁盘压力，不能因资源开销放宽物理预算或删去完整证据。
...
两档3332/4051步、302.97/348.23s；69328/80832记录格状态和319872/388896稠密格状态完成全来源、逐格元素/U/S、2/4求积和熵核查，全部通过原预算。基础/精细最大全体系U漂移7.898e-8/2.067e-8J，最大累计逐格U残差1.463e-7/2.254e-8J，最低步熵−7.606e-14/−4.336e-12J/K。1000共同观测的时间差T2.131e-8K、P.00009449Pa、相量9.462e-14mol，均通过。

8→16格1001共同观测的空间最大平均T .522030K、父格T 3.325676K、总相量1.068903e-5mol仍超原预算；平均P 99.588904Pa首次低于100Pa目标，但余量仅约.411Pa，且不能代表整组空间资格通过。无预算的父格P差14247.579Pa只报告。最大平均T/P/相量差出现在20s，父格T/P出现在40s；这些是所录观测时刻的最大值，不是连续时间上确界。

两档无损压缩66640932/79086303字节，4/5分片逐字节还原一致。完整十六格资格通过后冻结三十二格审计、空间比较与归档参数，继续同一物理定义及原预算。真实材料与有限速率资格保持未通过。

## 32格完整资格通过；空间仍未通过

2026-09-25 14:49 UTC。32格base5105步、refined6432步，实际积分951.12/1147.65 s。所有来源、逐格元素/U/S、2/4求积、熵符号及时间预算通过；记录状态195392/237856个、Gauss状态980160/1234944个。最大全局U残差1.0512121662e-7/1.9575054466e-8 J，四阶最大逐格累计U残差1.0029004827e-7/1.6980713724e-8 J；最小步总熵增-1.2071982303e-11/-1.4920564784e-12 J/K，均在原1e-10 J/K舍入预算内。1000个共同采样时刻两精度最大T/P/相量差3.0870523915e-8 K、9.4451941550e-5 Pa、4.6725901685e-14 mol。

16→32格的1001个观测（含初态）空间比较：平均温差0.2035650791 K、父格温差1.6152647305 K、总相量差3.7133501781e-6 mol，仍超过0.05 K、0.2 K、1e-8 mol目标；平均压差26.43728518 Pa低于100 Pa。前三项最大出现在20 s，平均压力最大在100 s；父格压差6970.441 Pa未设资格预算，单独报告。不能称空间收敛，所有原空间目标保持。

base/refined原始记录696543747/852320188字节，压缩189830484/234495700字节、11/13个分片，均逐字节回读一致。新64格审计、空间比较和归档参数已冻结，物理模型与虚拟传输参数不变。

## 64格完整资格通过；空间两项仍失败

2026-09-25 UTC。两档8936/11255步、2398.719/2782.922s。完整来源、逐格元素/U/S、2/4求积、熵和时间预算均通过；记录格635968/784384、Gauss格3431424/4321920纳入。最大全局能量残差1.476838e-7/2.403977e-8J，熵账本残差1.216075e-10/2.039945e-11J/K。1000共同观测的时间差T3.553874e-8K、P2.041741e-4Pa、相量5.112733e-14mol。

32→64空间均温0.048907745K、均压4.950736654Pa达到0.05K/100Pa原目标；父格温度0.453015237K和总相量9.348639e-7mol仍超过0.2K/1e-8mol。1001观测的最大差均在20s，父格压差2175.783894Pa仅为无预算诊断。全部35/43块无损归档611799113/762514242B，逐字节还原一致。继续128格两档和64→128同体积比较，所有原预算和虚拟系数保持。
