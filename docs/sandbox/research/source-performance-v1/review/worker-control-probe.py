...
def execute_case(name, *, evaluation_failure=False, profile_failure=False, audit_failure=False):
    ...
    with ExitStack() as stack:
        ...
        stack.enter_context(patch.object(configuration,'load_source_run_config',lambda raw:SimpleNamespace(canonical_bytes=b'{}',values={'resources':{'outer_seconds':510.}},sha256='c'*64)))
