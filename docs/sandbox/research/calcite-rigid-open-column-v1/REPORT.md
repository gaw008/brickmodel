...
32格两档12000s均已完成，分别23108/28089步、1031.27/1174.82s。全部逐格来源、局部/累计C/N/U、熵、表面约束与2/4阶积分核查通过；分别审查931520/1090912个已存单元状态。基础档最大累计单元U差4.15315e-6J、紧精度7.91111e-7J，仍在1e-5J原预算内。时间比较最大格温差1.35216e-5K、压差.0403706Pa、CaO差1.00187e-13mol，全部通过。两条记录压缩608102765/725827494字节，均逐字节往返一致。

16→32空间比较继续失败：均温2.51584K、格温42.2722K、均压18906.6Pa、CaO2.21747e-5mol、表温203.40064K，两个事件差3.39308/2.45078s。表温最大差位于初始t=0。17点独立半格边界距离研究表明，只有32768→65536等效均匀格数才把该初始表温差降至.180472K；没有因此计算或宣称65536格全过程。原均匀失败保持，后续采用[局部加密](../calcite-rigid-open-graded-v1/REPORT.md)。初始边界研究曾在JSON序列化时失败，修正NumPy布尔值后全部重算，原partial文件保留。
