...
def main(root, assets, out):
    ...
    case = root/'data/sandbox/cases/source-nonstationary-heos-v2.json'
    ...
    try:
        ...
        # V2: only solver precision tightened after the saved V1 failure.
        original['pressure_policy']['pressure_tolerance_pa'] = 1e-7
        original['inverse_policy']['energy_tolerance_j'] = 1e-6
