...
root=Path('/private/tmp/brick-source-dynamic-continuation-v1/native02/parent')
...
Path(__file__).with_name('V2_PARENT_EXTRACT.json').write_text(json.dumps(out,indent=2)+'\n')
