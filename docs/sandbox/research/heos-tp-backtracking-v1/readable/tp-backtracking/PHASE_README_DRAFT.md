...
Full installed regression and final independent audits will be recorded only after their actual terminal results. Readable XML strips trailing whitespace per line and ends with a newline; original raw XML remains in the ZIP with per-entry size and SHA256 verification.
