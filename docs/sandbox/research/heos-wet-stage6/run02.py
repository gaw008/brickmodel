...
command=['/usr/bin/env','PYTHONDONTWRITEBYTECODE=1','PYTHONPATH='+str(root/'src')+':'+str(root/'tests/sandbox'),'/private/tmp/brick-water-backend-probe/venv/bin/python',str(case/'child.py')]
r=run_attempt(case/'attempt02',command,cwd=case,input_paths=inputs,timeout_s=30)
