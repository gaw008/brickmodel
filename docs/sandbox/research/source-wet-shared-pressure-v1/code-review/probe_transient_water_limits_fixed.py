...
out=Path('/private/tmp/brick-source-wet-shared-pressure-v1/code-review/transient-water-limits-fixed')
...
try:
    ...
    assert not outcome['accepted'] and outcome['attempts']==0 and result['new_manufactured_requests']==0
    assert 'source_wet_provider_content_changed' in outcome['exception']
