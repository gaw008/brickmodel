"""Prepared single HEOS/source wet-to-dry study; importing this file runs no EOS.
...
PREVIOUS_RUNNER = 'source-root-comparison-v1/run_native.py'
PREVIOUS_RUNNER_SHA256 = '5b8c0e650e051a0ab4eb36e919eaaef18b271f51bb499add23f5e534c8434f28'
HELPERS = {
...
def run(root, output):
    ...
    result = dict(status='started', numerical_comparison_completed=False,
        ...
        scope='new_virtual_N1_1e-11mol_source_wet_to_dry_numerical_scenario',
        ...
        with patch.object(ExactSourceColumn, 'evaluate', observed):
            ...
            with patch.object(transition_module, 'execute_source_dry_candidate', retained_candidate):
                transition = transition_module.evaluate_source_dry_transition(refinement, end=seed.end,
                    maximum_callbacks_per_path=DRY_PATH_CALLBACK_CAP)
