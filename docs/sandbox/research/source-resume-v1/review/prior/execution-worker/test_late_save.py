...
def test_save_does_not_bypass_original_common_stop(monkeypatch,tmp_path,late):
    ...
    assert observed['failure']['status']==('resource_limit' if late=='wall' else 'cancelled')
    assert (output/'resume-point/WORKER_FAILURE.json').exists()
