...
class JoinedWaterVapor:
    ...
    def __init__(self,water_source_directory,thermochemistry_source_directory,*,low_enthalpy_error_j_mol,numerical_error_source_ids,backend="python",backend_manifest=None):
        ...
        low=IdealWaterVapor(water_source_directory,backend=backend,backend_manifest=backend_manifest)
