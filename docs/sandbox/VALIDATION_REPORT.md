...
2026-09-12[限定冷却热弹耦合](research/cooling-stress-v1/REPORT.md)完成实际安装两格绝热松弛与外冷却：原温度/局部全局能量/时间细化门槛通过，负对照漏耦合均检出；两条各原10s外部限额内完成，监督1.498250/1.493845s。相消缺陷与零流面问题已修，原RED/阈值保持；源码/安装各72项与独审10项通过。仍是常系数制造数值证据，没有空间收敛、同泥砖材料、相变或全周期资格。
