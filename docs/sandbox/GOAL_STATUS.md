...
[ENEA2024产物证据](research/enea-pyrolysis-products-v1/REPORT.md)补充炭/油/水相/气体终态约束及离线元素算术；尚无完整有限时间反应闭合。Mancuhan同家族新增几何事实未解除M1边界/测点限制，本窗口只读原已发会话未见回复。M1原生Goal仍blocked；真实干燥、高温、烧结/冷却及全周期材料验证仍未完成。无软件测试、SHA、子代理或新增对外通信。以下记录保留原阶段语境；最终64格冷凝与Git交付以新报告和实际回执为准。
