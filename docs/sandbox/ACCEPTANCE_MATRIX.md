...
| P02 | 炉温/壁温/气氛分段程序 | BoundaryProgram 41测试及真实积分节点/解析能量验证；动态气体库和热边界组装待完成 | in_progress |
| P03 | 导热/对流/辐射 | 物理实现、独立传热解 | in_progress |
| P04 | 液态水/蒸气迁移、蒸发 | 有据干燥本构与实验对照 | pending |
| P05 | 组成/温度储能、流焓、反应/相变 | 能量状态/推导，无重复热 | in_progress |
