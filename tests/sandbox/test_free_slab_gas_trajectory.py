...
def test_dry_gas_trajectory(water,tmp_path):
    ...
    for cap in (.00625,.003125):
        ...
        Path(os.environ.get('BRICK_FREE_SLAB_GAS_ARTIFACT',str(tmp_path/'results.json'))).write_text(json.dumps(runs,indent=2))
